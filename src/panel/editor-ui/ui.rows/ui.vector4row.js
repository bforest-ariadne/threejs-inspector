UI.Vector4Row = function () {
  ...
  var valueW	= new UI.Number().setWidth( '50px' ).setColor('black').onChange(update);
  ...
  this.valueW	= valueW
	...
	/**
	 * update the value
	 * @param  {THREE.Vector4} vector - the vector
	 */
...
UI.Vector4Row.prototype = Object.create( UI.Panel.prototype );
